...
export default class Rextract extends Extract {
  ...
  detectAll() {
    ...
    for (point.x = 1; point.x < (this.canvas.width - 1); point.x++) {
      for (point.y = 1; point.y < (this.canvas.height - 1); point.y++) {
